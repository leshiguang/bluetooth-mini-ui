...
public class QMUIStatusBarHelper {
    ...
    public static void translucent(AppCompatActivity activity) {
     ...
     */
    public static void translucent(AppCompatActivity activity, @ColorInt int colorOn5x) {
...
//            }
     ...
     */
    private static boolean setStatusBarLightMode(AppCompatActivity activity, @StatusBarType int type) {
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (QMUIDeviceHelper.isTablet(context)
                && sStatusbarHeight > UIUtil.dip2px(context,STATUS_BAR_DEFAULT_HEIGHT_DP)) {
