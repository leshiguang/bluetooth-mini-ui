...
public class StatusBarUtils {
     ...
     * @param color    状态栏颜色值
     */
    public static void setColor(@NonNull AppCompatActivity activity, @ColorInt int color) {
     ...
     * @param alpha    状态栏透明度
     */
    public static void setColor(@NonNull AppCompatActivity activity, @ColorInt int color, @IntRange(from = 0, to = 255) int alpha) {
     ...
     * @param activity 目标activity
     */
    public static void setDarkMode(@NonNull AppCompatActivity activity) {
     ...
     * @param activity 目标activity
     */
    public static void setLightMode(@NonNull AppCompatActivity activity) {
     ...
     */
    private static void setRootView(AppCompatActivity activity, boolean fitSystemWindows) {
